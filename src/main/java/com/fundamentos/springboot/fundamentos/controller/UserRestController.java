...
//RestController es para que todos los elementos se formateen con el formato json
@RestController
...
public class UserRestController {
    ...
    //Se implementa así para paginar
    ...
    //Ejemplo en Postman: http://localhost:8081/app/api/users/pageable?page=1&size=2
    @GetMapping("/pageable")
